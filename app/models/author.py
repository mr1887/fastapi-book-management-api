...
class Author(Base): # định nghĩa lớp Author kế thừa từ Base, đây sẽ là mô hình cơ sở dữ liệu cho bảng tác giả
    ...
    books = relationship("Book", back_populates="author") # thiết lập mối quan hệ với bảng sách, mỗi tác giả có thể có nhiều sách